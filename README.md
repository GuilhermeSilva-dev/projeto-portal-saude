...
* **[Seu Nome Aqui]** - RA: [Seu RA]
* **[Nome do Seu Colega Aqui]** - RA: [RA do Colega]
...
=========================================================================
Abra o terminal do seu sistema operacional (Prompt de Comando, PowerShell 
ou Git Bash) na pasta onde deseja salvar o projeto e digite o comando:

git clone https://github.com/SEU-USUARIO/SEU-REPOSITORIO.git

(Lembre-se de substituir a URL acima pelo link real do seu repositório)
